...
-  `Specify which fields to save <https://docs.djangoproject.com/en/stable/ref/models/instances/#ref-models-update-fields>`__ on a ``Collection`` instance
-  `Lock rows using SELECT ... FOR UPDATE <https://docs.djangoproject.com/en/stable/ref/models/querysets/#select-for-update>`__ on the ``collection`` table
...
.. seealso::
   ...
   -  `Integrating Django with a legacy database <https://docs.djangoproject.com/en/stable/howto/legacy-databases/>`__
