...
* If the `schema checks <../data-model/#schema-check-flags>` are enabled, the data are automatically checked for schema errors.
...
A :doc:`cli/index` allows you to list collections, add notes to collections, run schema checks, and transform collections (upgrade data from OCDS 1.0 to OCDS 1.1, and merge releases into compiled releases).
